package com.dgw.bimgcollection.login;
 ...
 * @data   2018年7月20日
 */
public class LoginTamall {
 
    public static String LOGIN_URL = "https://login.tmall.com/";
    public static String USER_AGENT = "User-Agent";
    public static String USER_AGENT_VALUE = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:52.0) Gecko/20100101 Firefox/61";
